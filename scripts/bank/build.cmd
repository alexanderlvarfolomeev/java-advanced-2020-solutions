...
set java_sources=%bank_folder%*.java %bank_folder%client\*.java %bank_folder%server\*.java %bank_folder%common\*.java %bank_folder%common\persons\*.java %bank_folder%common\accounts\*.java
